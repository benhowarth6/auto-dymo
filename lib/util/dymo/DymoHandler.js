...
module.exports = class DymoHandler {
    ...
    constructor() {
        this.hostname = constants.dymoHostname ? constants.dymoHostname : 'localhost';
    ...
    printLabel(name, ticketNumber, device, cost, repair, contact_number, date){
        try{
            ...
            jsonLabelData['DieCutLabel']['ObjectInfo']['TextObject']['StyledText']['Element'][0]['String'] = ticketNumber + "\n" + name + "\n" + contact_number + "\n" + device + "\n" + repair + "\n" + cost + "\n" + date;
